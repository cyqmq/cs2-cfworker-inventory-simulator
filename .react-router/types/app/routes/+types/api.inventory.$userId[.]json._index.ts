...
type Module = typeof import("../api.inventory.$userId[.]json._index.js")

type Info = GetInfo<{
  file: "routes/api.inventory.$userId[.]json._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.inventory.$userId[.]json._index.js");
}];
