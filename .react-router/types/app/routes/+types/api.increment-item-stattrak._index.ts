...
type Module = typeof import("../api.increment-item-stattrak._index.js")

type Info = GetInfo<{
  file: "routes/api.increment-item-stattrak._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.increment-item-stattrak._index.js");
}];
