...
type Module = typeof import("../api.consume-item-spray._index.js")

type Info = GetInfo<{
  file: "routes/api.consume-item-spray._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.consume-item-spray._index.js");
}];
