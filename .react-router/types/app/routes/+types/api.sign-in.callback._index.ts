...
type Module = typeof import("../api.sign-in.callback._index.js")

type Info = GetInfo<{
  file: "routes/api.sign-in.callback._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.sign-in.callback._index.js");
}];
