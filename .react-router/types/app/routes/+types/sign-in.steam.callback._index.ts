...
type Module = typeof import("../sign-in.steam.callback._index.js")

type Info = GetInfo<{
  file: "routes/sign-in.steam.callback._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../sign-in.steam.callback._index.js");
}];
