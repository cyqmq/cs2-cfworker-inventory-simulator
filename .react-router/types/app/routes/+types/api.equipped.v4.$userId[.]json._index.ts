...
type Module = typeof import("../api.equipped.v4.$userId[.]json._index.js")

type Info = GetInfo<{
  file: "routes/api.equipped.v4.$userId[.]json._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.equipped.v4.$userId[.]json._index.js");
}];
