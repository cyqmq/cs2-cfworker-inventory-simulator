...
type Module = typeof import("../translations.$language[.]json._index.js")

type Info = GetInfo<{
  file: "routes/translations.$language[.]json._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../translations.$language[.]json._index.js");
}];
