...
export type UserGroupWhereUniqueInput = Prisma.AtLeast<{
  groupId_userId?: Prisma.UserGroupGroupIdUserIdCompoundUniqueInput
  AND?: Prisma.UserGroupWhereInput | Prisma.UserGroupWhereInput[]
  OR?: Prisma.UserGroupWhereInput[]
  NOT?: Prisma.UserGroupWhereInput | Prisma.UserGroupWhereInput[]
  groupId?: Prisma.StringFilter<"UserGroup"> | string
...
export type UserGroupOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"groupId" | "userId", ExtArgs["result"]["userGroup"]>
...
export interface UserGroupDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many UserGroups and only return the `groupId`
   * const userGroupWithGroupIdOnly = await prisma.userGroup.createManyAndReturn({
   *   select: { groupId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserGroups and only return the `groupId`
   * const userGroupWithGroupIdOnly = await prisma.userGroup.updateManyAndReturn({
   *   select: { groupId: true },
   *   where: {
   *     // ... provide filter here
   *   },
